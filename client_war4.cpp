...
War4::War4(int width,int height,std::vector<std::string>& textures,SDL2pp::Renderer* renderer): 
	...
	house4(*renderer,textures[3]),
	house3(*renderer,textures[4]),
	house2(*renderer,textures[5]),
	house1(*renderer,textures[6]),
    wall(*renderer,textures[7]),
    road(*renderer,textures[8])
{
    x = width;
    y = height;
}
void War1::copy(int center, SDL2pp::Renderer* renderer){
	...
	renderer->Copy(ruins,SDL2pp::Rect(0,0,1920,1080),SDL2pp::Rect(-center_scenario(center/4),0,x,y));
	renderer->Copy(ruins,SDL2pp::Rect(0,0,1920,1080),SDL2pp::Rect(x-center_scenario(center/4),0,x,y));
	renderer->Copy(house4,SDL2pp::Rect(0,0,1920,1080),SDL2pp::Rect(-center_scenario(center/3),0,x,y));
	renderer->Copy(house4,SDL2pp::Rect(0,0,1920,1080),SDL2pp::Rect(x-center_scenario(center/3),0,x,y));
