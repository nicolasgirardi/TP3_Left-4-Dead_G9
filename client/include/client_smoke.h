#ifndef CLIENT_SMOKE_H
#define CLIENT_SMOKE_H
...
class Smoke: public Character {
    private:
    LoopAnimation idle;
    NoLoopAnimation smoke;

    public:
    Smoke(int pos_x,int pos_y,int width,int height,std::vector<SDL2pp::Texture*>& texture,uint32_t frame,int ID);
